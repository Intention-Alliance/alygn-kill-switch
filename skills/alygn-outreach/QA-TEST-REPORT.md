...
- State file saved to `$HOME/.openclaw/workspace/reports/alygn/vc-discover/alygn-vc-discovered-2026-03-26.json`
...
- State file saved to `$HOME/.openclaw/workspace/reports/alygn/muni-discover/alygn-municipal-discovered-2026-03-26.json`

### 3.4 Personalize with Input File

```bash
bun run bin/alygn-outreach.ts --type=municipal --action=personalize --input=$HOME/.openclaw/workspace/reports/alygn/outreach-test/test.json --dry-run
```
...
1. **Notion Config External Dependency**
...
_Report generated by QA Subagent_
_Task: QA Testing of Self-Contained alygn-outreach Skill_
