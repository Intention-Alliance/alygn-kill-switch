...
// Audit route error boundary — catches errors in the Ollama audit log page
    ...
    <div className="flex items-center justify-center min-h-[300px] p-6">
      <div className="w-full max-w-lg rounded-xl border border-gray-800 bg-gray-900 p-6 text-center">
        <div className="mb-4">
          ...
          <h2 className="text-lg font-semibold text-gray-100">Audit Log Error</h2>
          <p className="text-sm text-gray-500 mt-1">
            Failed to load the Ollama audit log. Please try again.
          </p>
        </div>
