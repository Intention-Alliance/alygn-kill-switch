...
- Command: USE_DIRECT_API=true bun ~/.openclaw/workspace/skills/alygn-outreach/bin/alygn-outreach.ts --type=angel --action=discover --source=angellist,linkedin,gmail --limit=15
- Output: Raw angel lead data

### Phase 3: Enrich Leads

- Command: bun ~/.openclaw/workspace/skills/alygn-outreach/bin/alygn-outreach.ts --type=angel --action=research --input=/tmp/discoveries/angel-{today}.json
...
- Output: /tmp/waves/wave-{today}-angel.json with status "researched"
