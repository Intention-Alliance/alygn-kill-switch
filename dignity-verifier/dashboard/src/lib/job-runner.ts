 ...
 * via dignity-verifier/.gitignore → reports/). A bounded tail (≤100
...
// Logs land in dignity-verifier/reports/runs/ (gitignored via
// dignity-verifier/reports/ in the repo root .gitignore). Overridable
