...
describe("End-to-End Telemetry Flow", () => {
	...
	it.skipIf(SKIP_E2E_TESTS)(
		"Challenge Scenario 2: Immutability Enforcement",
		async () => {
	...
	it.skipIf(SKIP_E2E_TESTS)(
		"Challenge Scenario 3: Kill-Switch Latency",
		async () => {
...
if (SKIP_E2E_TESTS) {
	console.log(
		"⚠️ E2E tests skipped - set SUPABASE_URL and SUPABASE_SERVICE_KEY",
	);
}
