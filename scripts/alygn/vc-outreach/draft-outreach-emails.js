...
const { generateEmailHTML } = require('./vc-outreach-email-template.js');
...
- "Institutional AI Governance"
  ...
  try {
    ...
    console.error(`   ⚠️  Subject line generation failed: ${error.message}`);
    // Fallback subjects
    return {
      optionA: 'AI Governance Infrastructure',
      optionB: 'Coordination Before Crisis',
      optionC: 'The Real AI Risk is Coordination Failure',
      recommended: 'A (governance-first positioning)'
    };
  }
}
...
module.exports = { getReadyVCs, draftEmail, generateSubjectLines, selectVariant };
