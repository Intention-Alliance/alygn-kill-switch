...
CREATE INDEX idx_municipalities_country ON municipalities(country);
CREATE INDEX idx_municipalities_wave ON municipalities(wave_number);
CREATE INDEX idx_municipalities_status ON municipalities(outreach_sent_at);
CREATE INDEX idx_municipalities_priority ON municipalities(priority_score DESC);
CREATE INDEX idx_municipalities_x_handle ON municipalities(x_handle);
CREATE INDEX idx_municipalities_discovered ON municipalities(discovered_at);
...
-- Indexes
CREATE INDEX idx_outreach_emails_municipality ON outreach_emails(municipality_id);
...
-- Indexes
CREATE INDEX idx_x_engagements_municipality ON x_engagements(municipality_id);
CREATE INDEX idx_x_engagements_type ON x_engagements(engagement_type);
CREATE INDEX idx_x_engagements_engaged_at ON x_engagements(engaged_at);
...
CREATE TRIGGER trg_update_priority_score
