...
**Location:** `/home/andlersrv/.openclaw/workspace/scripts/alygn/x-twitter/x-api-executor.js`
...
| `x-twitter/x-api-executor.js` | Created | Execution pipeline |
...
// Run executor
execSync(`bun scripts/alygn/x-twitter/x-api-executor.js ${outputFile} --dry-run`);
