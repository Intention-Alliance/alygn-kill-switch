...
1. `$HOME/.openclaw/workspace/scripts/alygn/x-growth/parser/twitter-content-parser.js`
...
1. `$HOME/.openclaw/workspace/scripts/alygn/x-growth/parser/test-xml-input.js`
...
```bash
cd $HOME/.openclaw/workspace/scripts/alygn/x-growth/parser
